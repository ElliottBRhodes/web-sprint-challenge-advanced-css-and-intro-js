...
function getArtistByIndex(array, number){
  return `the artist at index ${artists.number} is ${artists.array}`
}
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 4: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
function addArtist(array){
    return artists.push({'id': 20, 'name': 'Elliott-Rhodes', 'years': 1996 - 16, 'genre': 'Web-Design', 'nationality': 'Black', 'bio': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec nulla in erat iaculis tempus. Ut eros erat, porta vel ultricies eget, consequat sed sem.'})
  }
